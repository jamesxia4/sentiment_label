...
var Chart = Highcharts.Chart,
	...
	extend(defaultOptions.lang, {
		showTable: "显示/关闭数据",
		DownloadData: "下载数据",
		downloadDataInCSVFormat: '下载 CSV 格式数据文档',
		downloadDataInXLSFormat: '下载 XLS 格式数据文档',
		line: '折线图',
		column: '柱形图',
		spline: '曲线图',
		area: '面积图',
		...
		stackedcolumn: '堆积柱形图',
		stackedarea: '堆积面积图',
		stackedpercentbar: '百分比堆积条形图',
		stackedpercentcolumn: '百分比堆积柱形图',
		stackedpercentarea: '百分比堆积面积图',		
		printChart: '打印图片',
		downloadPNG: '下载为 PNG 格式图片',
		downloadJPEG: '下载为 JPEG 格式图片',
		downloadPDF: '下载为 PDF 格式文档',
		downloadSVG: '下载为 SVG 格式矢量图片',
		contextButtonTitle: '图片菜单',
		uniqueyaxis: '设为单个纵坐标轴'
